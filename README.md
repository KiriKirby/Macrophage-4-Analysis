...
## Overview
- Main script: `Macrophage Image Four-Factor Analysis_2.2.3.ijm`
...
1. Open Fiji.
2. Drag and drop `Macrophage Image Four-Factor Analysis_2.2.3.ijm` into the Fiji window.
...
## License
MIT is recommended. Use GPL-3.0 if copyleft is required.
